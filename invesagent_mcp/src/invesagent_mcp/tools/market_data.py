...
from invesagent_core.services.analysis.price import analyze_ohlcv_price_trend
from invesagent_core.services.charts.price import generate_ohlcv_price_chart
from invesagent_core.services.data.market_data import get_cn_trade_calendar, get_ohlcv
...
def register_market_data_tools(mcp) -> None:
    ...
    def generate_ohlcv_price_chart_tool(
        ...
        """Generate a configurable OHLCV price chart with optional technical indicators."""
