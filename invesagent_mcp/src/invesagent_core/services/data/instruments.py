...
from invesagent_core.providers.akshare.instruments import maybe_resolve_akshare_instrument
from invesagent_core.providers.tushare.instruments import resolve_stock_code
...
def resolve_instrument(
    ...
    if provider == "akshare" or market in ("hk", "us"):
        akshare_resolved = maybe_resolve_akshare_instrument(
            value,
            market=market,
            asset_type=asset_type,
        )
        if akshare_resolved is not None:
            return akshare_resolved
